...
def hefty_hogs(player_score, opponent_score):
    ...
    if opponent_score == 0:
        return 1
    # Case that opponent_score != 0
    opponent_score_copy = opponent_score
    result = player_score
    while 1==1:
        digit = opponent_score_copy % 10
        result = digit_fn(digit)(result)
        opponent_score_copy //= 10
        if opponent_score_copy == 0:
            break
    return result % 30
    # END PROBLEM 2
...
def hog_pile(player_score, opponent_score):
    ...
    ones_digit_opponent = opponent_score % 10
    if ones_digit_player == ones_digit_opponent:
        return ones_digit_player
    else:
        return 0
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    strategy_of = [strategy0, strategy1]
    score_of = [score0, score1]
